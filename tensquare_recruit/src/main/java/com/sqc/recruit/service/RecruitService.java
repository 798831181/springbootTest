package com.sqc.recruit.service;

import com.sqc.recruit.dao.RecruitDao;
...
public class RecruitService {
	 ...
	 * 查询最新职位
	 */
	public List<Recruit> findNew(String status){
		return recruitDao.findTop6ByStateNotOrderByCreatetimeDesc(status);
	}
	/**
	 * 获得推荐职位
	 */
	public List<Recruit> findRecommend(String status){
		return recruitDao.findTop6ByStateOrderByCreatetimeDesc(status);
	}
