package com.sqc.recruit.controller;
...
import com.sqc.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result findNew(){
		List<Recruit> recruits = recruitService.findNew("0");
	...
	public Result findRecommend(){
		List<Recruit> recommend = recruitService.findRecommend("2");
